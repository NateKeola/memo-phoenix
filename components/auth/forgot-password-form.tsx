...
// The self-service email-recovery form (the real recovery path). Submitting emails a
// reset link via Supabase (custom SMTP is configured). It returns a neutral message
